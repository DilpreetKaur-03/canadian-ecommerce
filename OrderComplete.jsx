          ...
          <div>
            <div style={codeBox}>
              ...
              <div style={{ marginTop: 12, color: "#374151" }}>
                We’ve emailed an order confirmation to <strong>{(order && order.customer && order.customer.email) || (order && order.customer?.email) || "you"}</strong>. If you don’t see it, check your spam folder.
              </div>
